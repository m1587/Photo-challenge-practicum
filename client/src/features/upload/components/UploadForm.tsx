...
import { Button, Box, Card, CardContent, CardActions, Typography, CircularProgress } from "@mui/material"
import ImageIcon from "@mui/icons-material/Image"
import ErrorSnackbar from "../../../components/pages/Error"
import SuccessSnackbar from "../../../components/pages/Success"
...
export const UploadForm: React.FC<UploadFormProps> = ({
  ...
  const handleFileSelect = (selectedFile: File) => {
    // Create a synthetic event for compatibility with the parent component's handler
    const syntheticEvent = {
      target: {
        files: [selectedFile],
      },
  ...
  return (
    ...
    >
      <CardContent sx={{ p: 4 }}>
        ...
        <CaptionInput value={currentCaption} onChange={setCurrentCaption} isVisible={!!file && !isCaptionUpdated} />
